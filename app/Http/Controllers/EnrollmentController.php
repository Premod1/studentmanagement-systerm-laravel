...
class EnrollmentController extends Controller
{
    ...
    public function store(Request $request) :RedirectResponse
    {
        ...
        return redirect('enrollments')->with('flash_message','Enrolments Added Successfully');
    }
    ...
    {
        $enrollments = Enrollment::find($id);
        return view('enrollments.edite')->with('enrollments', $enrollments);
    }
    ...
    public function destroy(string $id): RedirectResponse
    {
        ...
        return redirect('enrollments')->with('flash_message','delete enrollments successfully');
    }
}
